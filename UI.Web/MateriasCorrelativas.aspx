<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MateriasCorrelativas.aspx.cs" Inherits="UI.Web.MateriasCorrelativas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="gridPanel" runat="server" style="margin-top: 160px;">
        <asp:Label ID="lblMateriaPlan" runat="server" Text="Materias" style="margin-left: 5%;" Font-Size="X-Large" Font-Bold="True"></asp:Label>
